...
<head>
    ...
    <title>Actualizar Clase de Producto</title>
</head>
<body>
<div class="container">
    <h1>Actualizar Clase de Producto</h1>
    <div class="navigation">
    <form action="index.php?action=searchClassProductByNameU" method="get">
        <input type="hidden" name="action" value="searchClassProductByNameU">
