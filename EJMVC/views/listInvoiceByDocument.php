...
<head>
    ...
    <title>Buscar Factura por Numero Documento Cliente</title>
</head>
<body>
<div class="container">
    <h1>Buscar Factura por Numero Documento Cliente</h1>
    <div class="navigation">
    <form action="index.php?action=searchInvoiceByDocument" method="get">
        <input type="hidden" name="action" value="searchInvoiceByDocument">
        <input type="text" name="numDocument" require>
